...
export default function App(props) {
    ...
    <div className="app" >
      ...
      <div class="row">
      <Card titulo="PalavraAleatoria"><PalavraAleatoria min={0} max={5}></PalavraAleatoria></Card>
      <Card titulo="CoresAleatorias"><CoresAleatorias min={0} max={15}></CoresAleatorias></Card>
      </div>
      </div>
